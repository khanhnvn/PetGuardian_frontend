        ...
        <Box bg="#FFFCF8" minHeight="100vh" display="flex" flexDirection="column">
            ...
            <Box flex={1} display="flex" flexDirection="column" alignItems="center"> {/* Center content vertically */}
                <Container maxW="container.lg" p={4} textAlign="center"> {/* Center text */}
                    <VStack spacing={2} alignItems="center" mt={4}> {/* Add margin top */}
                    ...
                    <HStack spacing={4} mt={10} justifyContent="center"> {/* Center the images */}
                        <Image src="/image1.png" alt="Mèo" h="200px" objectFit="cover" borderRadius="30px" /> {/* Adjusted height and border radius */}
                        <Image src="/image.png" alt="Chó" h="200px" objectFit="cover" borderRadius="30px" /> {/* Adjusted height and border radius */}
                    </HStack>
                </Container>
            </Box>
            <Footer />
